...
internal sealed class _003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__CudaEightBitFormatRegex_16 : Regex
{
	private sealed class RunnerFactory : RegexRunnerFactory
	{
		private sealed class Runner : RegexRunner
		{
			...
			{
				int num = runtextpos;
				if (num <= inputSpan.Length - 22)
				{
					int num2 = inputSpan.Slice(num).IndexOfAny(_003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__Utilities.s_indexOfAnyStrings_OrdinalIgnoreCase_C54B5661665FE8B6C590E24093B38E4356A59458FE50240D8300FF3B140A2F6D);
					if (num2 >= 0)
					{
						runtextpos = num + num2;
						return true;
			...
			private bool TryMatchAtCurrentPosition(ReadOnlySpan<char> inputSpan)
			{
				...
				case 'O':
				case 'o':
					if ((uint)readOnlySpan.Length < 7u || !readOnlySpan.Slice(1).StartsWith("verlay", StringComparison.OrdinalIgnoreCase))
					{
						UncaptureUntil(0);
						return false;
					}
				...
				if ((uint)readOnlySpan.Length < 6u || !readOnlySpan.StartsWith("_cuda", StringComparison.OrdinalIgnoreCase) || readOnlySpan[5] != '=')
				{
					UncaptureUntil(0);
					return false;
				}
	...
	internal static readonly _003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__CudaEightBitFormatRegex_16 Instance = new _003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__CudaEightBitFormatRegex_16();

	private _003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__CudaEightBitFormatRegex_16()
	{
		pattern = "((?:scale|overlay)_cuda=[^,\\s\"']*?format=)(?:nv12|yuv420p)(?=[: ,\"']|$)";
