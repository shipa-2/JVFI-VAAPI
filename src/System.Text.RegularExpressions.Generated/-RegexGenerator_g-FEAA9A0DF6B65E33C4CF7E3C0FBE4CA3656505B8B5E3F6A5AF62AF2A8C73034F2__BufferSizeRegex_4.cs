...
internal sealed class _003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__BufferSizeRegex_4 : Regex
{
	private sealed class RunnerFactory : RegexRunnerFactory
	{
		private sealed class Runner : RegexRunner
		{
			...
			private bool TryFindNextPossibleStartingPosition(ReadOnlySpan<char> inputSpan)
			{
				...
				{
					int num2 = inputSpan.Slice(num).IndexOfAny(_003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__Utilities.s_indexOfString_A1FBC50E3481D6B349A26CEC44C0B75C53A3FB219B182FFD57F7F59D1F6618EC);
					if (num2 >= 0)
					{
						runtextpos = num + num2;
						return true;
			...
			private bool TryMatchAtCurrentPosition(ReadOnlySpan<char> inputSpan)
			{
				...
				num = num5;
				span = inputSpan.Slice(num);
				if ((uint)span.Length < 8u || !span.StartsWith("-bufsize", StringComparison.OrdinalIgnoreCase))
				{
					UncaptureUntil(0);
					return false;
				}
	...
	internal static readonly _003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__BufferSizeRegex_4 Instance = new _003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__BufferSizeRegex_4();

	private _003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__BufferSizeRegex_4()
	{
		pattern = "(?<!\\S)-bufsize(?::v(?::0)?)?\\s+(\\d+)";
