...
internal sealed class _003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__VaapiEightBitFormatRegex_15 : Regex
{
	private sealed class RunnerFactory : RegexRunnerFactory
	{
		private sealed class Runner : RegexRunner
		{
			...
			private bool TryFindNextPossibleStartingPosition(ReadOnlySpan<char> inputSpan)
			{
				...
				{
					int num2 = inputSpan.Slice(num).IndexOfAny(_003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__Utilities.s_indexOfAnyStrings_OrdinalIgnoreCase_B5A80BD0D90005DE13CE507EB755A1CE7F26115C05CBCCFDAE14B70978DC262B);
					if (num2 >= 0)
					{
						runtextpos = num + num2;
						return true;
			...
			private bool TryMatchAtCurrentPosition(ReadOnlySpan<char> inputSpan)
			{
				...
				case 'T':
				case 't':
					if ((uint)readOnlySpan.Length < 7u || !readOnlySpan.Slice(1).StartsWith("onemap", StringComparison.OrdinalIgnoreCase))
					{
						UncaptureUntil(0);
						return false;
					}
				...
				if ((uint)readOnlySpan.Length < 7u || !readOnlySpan.StartsWith("_vaapi", StringComparison.OrdinalIgnoreCase) || readOnlySpan[6] != '=')
				{
					UncaptureUntil(0);
					return false;
				}
	...
	internal static readonly _003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__VaapiEightBitFormatRegex_15 Instance = new _003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__VaapiEightBitFormatRegex_15();

	private _003CRegexGenerator_g_003EFEAA9A0DF6B65E33C4CF7E3C0FBE4CA3656505B8B5E3F6A5AF62AF2A8C73034F2__VaapiEightBitFormatRegex_15()
	{
		pattern = "((?:scale|tonemap)_vaapi=[^,\\s\"']*?format=)(?:nv12|yuv420p)(?=[: ,\"']|$)";
